...
1) вызывать функцию для получения данных из базы.
2) предложи улучшения для сбербанка для улучшения клиентского опыта

Правила получения данных:
1) вызови функцию СТРОГО один раз!
2) обязательно выводи в ответе json с полями text - ответ агента, csv - True (если бы сформирован отчет), png - True (если был построен график) 
"""
